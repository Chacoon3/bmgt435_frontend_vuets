...
<template>
    <div class="portalSubmodule">
        ...
        <form autocomplete="on" id="signUpForm" @submit.prevent="handleSignUp">
            ...
            <div class="formDiv">
                <input class="inputField" type="password" name="password" v-model="signUpForm.password" placeholder="password">
            </div>
            <div class="formDiv">
                <label id="passwordLabel" :passwordMatch="passwordMatch" for="check_password">verify password</label>
            </div>
            <div class="formDiv">
                <input class="inputField" type="password" name="check_password" v-model="password_retyped" placeholder="password">
            </div>
            <div class="formDiv">
                <input type="submit" :value="isSigningUp? 'Signing up...': 'Sign Up'" :disabled="isSigningUp">
            </div>
        </form>
    </div>
</template>
